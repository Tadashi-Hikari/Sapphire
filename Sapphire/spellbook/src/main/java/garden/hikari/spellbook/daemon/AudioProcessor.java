...
import com.example.framework.audiohelper.DataManager;
...
public class AudioProcessor implements Runnable {
    ...
    class StreamListener implements RecognitionListener {
        ...
        public void onTimeout(){
            Log.e("PhonemeProcessor","The processor timed out");
        }
    }
    ...
    public void streamFromNamedPipe(FileDescriptor fileDescriptor) throws Exception{
