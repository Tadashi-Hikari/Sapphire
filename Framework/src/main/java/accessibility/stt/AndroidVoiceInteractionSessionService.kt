...
import audio.RecognitionService.CustomSpeechRecognizer
...
class AndroidVoiceInteractionSessionService: RecognitionListener, VoiceInteractionSessionService(){
    ...
    override fun onNewSession(args: Bundle?): AndroidVoiceInteractionSession {
        Log.d(this.javaClass.name, "Creating a new session")
        return AndroidVoiceInteractionSession(this)
    }
