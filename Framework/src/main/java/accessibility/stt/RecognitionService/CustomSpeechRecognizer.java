package accessibility.stt.RecognitionService;
...
public class CustomSpeechRecognizer {
    ...
    public CustomSpeechRecognizer(Model model, String hotwords) throws IOException {
        this.recognizer = new KaldiRecognizer(model, 16000.0F, hotwords);
        this.sampleRate = 16000;
        this.bufferSize = Math.round((float)this.sampleRate * 0.4F);
        this.recorder = new AudioRecord(6, this.sampleRate, 16, 2, this.bufferSize * 2);
        // This is added by me (Hikari Tadashi), trying to use noise suppression to increase recognition
