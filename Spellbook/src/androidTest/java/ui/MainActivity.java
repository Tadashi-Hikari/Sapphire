...
import com.example.spellbook.daemon.AudioProcessor;
import com.example.spellbook.daemon.AudioProcessHandler;

import java.util.ArrayList;

import garden.hikari.spellbook.R;
import com.example.spellbook.daemon.SimpleAudioProcessor;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void launchProcessor(View view){
        ...
        commandIntent.setClass(this, SimpleAudioProcessor.class);
        startService(commandIntent);
        notification();
    }

    public void launchPipedProcessor(View view){
        Intent commandIntent = new Intent();
        commandIntent.setAction(SimpleAudioProcessor.NEW);
        commandIntent.putExtra(AudioProcessor.TYPE,AudioProcessor.WAKE);
        notification();
    ...
    public void notification(){
        ...
        notificationIntent.setAction("start_notification");
        notificationIntent.setClass(this,SimpleForegroundService.class);
